...
element.phoneConfirmationCode.getPhoneConfirmationCodeElement = function() {
  return this.getElementByClass(goog.getCssName('firebaseui-id-phone-confirmation-code'));
};
...
element.phoneConfirmationCode.getPhoneConfirmationCodeErrorElement =
    function() {
  return this.getElementByClass(goog.getCssName('firebaseui-id-phone-confirmation-code-error'));
};
