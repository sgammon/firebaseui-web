...
element.newPassword.getPasswordToggleElement = function() {
  return this.getElementByClass(goog.getCssName('firebaseui-id-password-toggle'));
};
...
element.newPassword.getNewPasswordErrorElement = function() {
  return this.getElementByClass(goog.getCssName('firebaseui-id-new-password-error'));
};
