...
element.NewPasswordTestHelper.prototype.testTogglePassword_ = function() {
  ...
  assertTrue(goog.dom.classlist.contains(toggle, goog.getCssName('firebaseui-input-toggle-on')));
  assertEquals('password', password['type']);

  // Click on the eye icon.
  goog.testing.events.fireClickEvent(toggle);
  assertTrue(
      goog.dom.classlist.contains(toggle, goog.getCssName('firebaseui-input-toggle-off')));
...
element.NewPasswordTestHelper.prototype.testFocusNewPassword_ = function() {
  ...
  assertTrue(
      goog.dom.classlist.contains(toggle, goog.getCssName('firebaseui-input-toggle-focus')));
  assertFalse(
      goog.dom.classlist.contains(toggle, goog.getCssName('firebaseui-input-toggle-blur')));
